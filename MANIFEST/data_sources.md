...
| 数据 | 路径 |
|---|---|
| TY 观影 9 类 pkl | `/data/liujialing/TY/预处理/python/Preprocessing/全部的TY/output/9_movie/data_9class_movie.pkl` |
...
| 问卷（播放顺序） | `/data/liujialing/TY/data/data-tongyong/原始数据/问卷/`（129 个被试子目录） |
| FACED 预处理 mat | `/data/liujialing/TY/data/data-faced/0.05–47 Hz_mat/` |
