...
from .io_utils import get_ty6_save_base
import numpy as np
...
class EEGDataModule(pl.LightningDataModule):
    def __init__(self, cfg, train_subs, val_subs, 
        ...
        super().__init__()
        save_base = get_ty6_save_base(cfg)
        self.load_dir = cfg.data_dir if getattr(cfg, 'dataset_name', None) == 'TY6' else os.path.join(cfg.data_dir, 'processed_data')
        self.save_dir = os.path.join(save_base, 'sliced_data')
